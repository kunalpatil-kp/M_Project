...
- Name: production.spec.js >> 04_register_new_user
- Location: tests\production.spec.js:54:1
...
Call log:
  - waiting for locator('button[type=submit], button').filter({ hasText: /create|sign.?up|register|continue/i }).first()
...
- generic [ref=e2]:
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e7]:
      - textbox "Your email" [ref=e8]: pwuser_1783929576428@test.com
